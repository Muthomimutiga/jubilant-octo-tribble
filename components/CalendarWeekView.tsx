...
import { TIME_LABELS, getWeekDays, toISODateString, calculateEventPosition } from '../utils/date';
...
const CalendarWeekView: React.FC<CalendarWeekViewProps> = ({ currentDate, tasks, events, onEventClick, onTaskClick, onDateClick }) => {
    const weekDays = getWeekDays(currentDate);
    const today = toISODateString(new Date());

    return (
        <div className="calendar-view-container week-view">
            {/* Time labels column */}
            ...
            {weekDays.map((day, index) => {
                ...
                return (
                    <div key={index} className="day-column">
                        ...
                        <div className="all-day-section" onClick={(e) => onDateClick(day, e)}>
                        ...
                        <div className="timed-section" onClick={(e) => onDateClick(day, e)}>
